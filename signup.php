        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <img class="left-image" src="images/thumbsUp.png" alt="Left Image">
                        <h1 class="card-title">Create your Hangman Account!</h1>
                        <h3>Already have an account? <a href="signin.php">Login here</a><h3>
                    </div>
                    <div class="card-body">
                    <h4 class="text-center">You're almost there! Complete your registration to start playing!</h4>

                        <?php
                        $gamer_id = isset($_GET["gamer_id"]) ? $_GET["gamer_id"] : null; 
                        $action = "processes/register.php?gamer_id=" . $gamer_id;
                        ?>
